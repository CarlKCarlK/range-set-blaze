    ...
    R: SortedDisjointMap<T, V>,
{
    ...
    iter: MergeBy<L, R, fn(&RangeValue<T, V>, &RangeValue<T, V>) -> bool>,
}

impl<T, V, L, R> MergeMap<T, V, L, R>
where
    T: Integer,
    V: PartialEq,
    L: SortedDisjointMap<T, V>,
...
impl<T, V, L, R> FusedIterator for MergeMap<T, V, L, R>
where
    T: Integer,
    V: PartialEq,
    L: SortedDisjointMap<T, V>,
...
impl<T, V, L, R> Iterator for MergeMap<T, V, L, R>
where
    T: Integer,
    V: PartialEq,
    L: SortedDisjointMap<T, V>,
...
impl<T, V, L, R> SortedStartsMap<T, V> for MergeMap<T, V, L, R>
where
    T: Integer,
    V: PartialEq,
    L: SortedDisjointMap<T, V>,
