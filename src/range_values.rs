...
// impl<'a, T: Integer, V: ValueOwned + 'a> SortedStartsMap<'a, T, V> for IntoRangeValuesIter<T, V> {}
// impl<'a, T: Integer, V: ValueOwned + 'a> SortedDisjointMap<'a, T, V> for IntoRangeValuesIter<T, V> {}
